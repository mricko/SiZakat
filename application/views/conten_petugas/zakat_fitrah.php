              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  <div class="x_title pull-right">
                    <a href="<?php echo base_url('petugas/Dashboard') ?>"><i class="fa fa-home"></i>  Dashboard / </a><a href="#">Zakat Fitrah</a>
                  </div>
                   </div>
              </div>  
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="20%">
                            <center>
                            <a class="btn btn-primary" title="Print Kwitansi" target="_blank" href="<?php echo base_url('petugas/fitrah/print_kwitansi_fitrah/' . $row->id_zakat_fitrah) ?>"><i class="fa fa-print"></i></button></a>
                            ...
                            <a class="btn btn-danger hapus-fitrah" title="Hapus Data Zakat Fitrah" href="<?php echo base_url('petugas/Fitrah/hapus_data/'.$row->id_zakat_fitrah) ?>"><i class="fa fa-trash"></i></a>
                          </center>
                          </td>
                        </tr>
                        <?php } ?>
