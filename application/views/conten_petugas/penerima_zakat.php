      ...
      <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  <div class="x_title pull-right">
                    <a href="<?php echo base_url('petugas/Dashboard') ?>"><i class="fa fa-home"></i>  Dashboard / </a><a href="#">Data Mustahik</a>
                  </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="hapus-penerima" href="<?php echo base_url('petugas/penerima/hapus_data_penerima/'.$row->id_penerima) ?>"><button type="button" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></button></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
...
<div class="modal fade bs-example-modal-smTambah" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <form method="post" action="<?php echo base_url('petugas/Penerima/tambah_penerima') ?>">
...
<div class="modal fade bs-example-modal-smImport" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <form method="post" action="<?php echo base_url('petugas/penerima/import') ?>" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                          </button>
...
<div class="modal fade bs-example-modal-smEdit<?php echo $y++; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <form method="post" action="<?php echo base_url('petugas/penerima/update_data_penerima/'.$row->id_penerima) ?>">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                          </button>
