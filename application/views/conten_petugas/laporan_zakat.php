              ...
              <div class="title_left">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  <div class="x_title pull-right">
                    <a href="<?php echo base_url('petugas/Dashboard') ?>"><i class="fa fa-home"></i>  Dashboard / </a><a href="#">Laporan Zakat </a>
                  </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a target="_blank" href="<?php echo base_url('petugas/Laporan/cetak_laporan_zakat_fitrah') ?>">
                ...
                <a target="_blank" href="<?php echo base_url('petugas/Laporan/cetak_laporan_zakat_maal') ?>">
                <div class="animated flipInY col-lg-6 col-md-3 col-sm-6 col-xs-12">
                  <div class="tile-stats">
              ...
              <form method="post" target="_blank" action="<?php echo base_url('petugas/Laporan/laporan_penerima_zakat') ?>">
