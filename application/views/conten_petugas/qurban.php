              ...
              <div class="title_left">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  <div class="x_title pull-right">
                    <a href="<?php echo base_url('petugas/Dashboard') ?>"><i class="fa fa-home"></i>  Dashboard / </a><a href="#">Data Qurban</a>
                  </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <a class="btn btn-primary" target="_blank" href="<?php echo base_url('petugas/qurban/cetak_kupon') ?>">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="12%">
                            ...
                            <!-- <a href="<?php echo base_url('petugas/qurban/edit_data/'.$row->id_qurban) ?>"><button type="button" class="btn btn-warning"><i class="fa fa-edit"></i></button></a> -->
                            <a class="btn btn-danger hapus-qurban" title="Hapus Data Qurban" href="<?php echo base_url('petugas/qurban/hapus_data/'.$row->id_qurban) ?>"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-bg">
    <div class="modal-content">
      <form method="post" name="qurban" action="<?php echo base_url('petugas/qurban/tambah_qurban') ?>">
...
<div class="modal fade" id="ModalEdit<?php echo $y++ ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-bg">
      <div class="modal-content">
        <form method="post" name="qurban" action="<?php echo base_url('petugas/qurban/edit_data/') . $row->id_qurban ?>">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
            </button>
