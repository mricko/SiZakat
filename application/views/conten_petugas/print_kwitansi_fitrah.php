...
foreach ($data_peserta->result() as $row) { ?>
	<title>Kwintasi <?php echo $row->nama_pemberi_zakat; ?></title>
<style type="text/css"></style>
</head>
<body>

 <table width="100%" cellpadding="4" cellspacing="0" style="border: 1px solid #000; font-size: 13px">   <tr>
   <td valign="top" align="center"><img style="width: 70px; height: 70px" src="<?php echo ('./assets/img/'.$logo)?>"></td>
   <td valign="top" colspan="3">
      <table>
         <tr>
            <td><b>Bandan Amil Zakat</b></td>
         </tr>
         <tr>
 ...
 <tr>
   ...
   <td valign="top" width="17%" style="border-top: 1px solid"> Muzaki </td>
 ...
 <tr>  
   <td valign="top" > Jumlah Jiwa </td>
   <td valign="top" > : </td>    
   <td valign="top" ><?php echo $row->besaran_jiwa; ?> Jiwa</td>  
 </tr> 
 <tr>  
   <td valign="top" > Jumlah Beras </td>
   <td valign="top" > : </td>    
   <td valign="top" > <?php 
                            $beas = $row->beras;
                            if ($beas == '') {
  ...
  <tr>  
   ...
   <td valign="top" >  <?php 
                            ...
                            if ($dana == '') {
                              ...
                              echo "<br>";
                              echo "<i><b>(".ucwords(Terbilang($row->uang))." Rupiah )</b></i>"; 
                            }
                            ?>                              
   </td>  
  ...
  <tr>  
   <td><br> <h3>&nbsp; &nbsp;  Zakat Fitrah</h3> </td>  
   <td colspan="2" valign="top" height="80" align="right">
      <table width="40%" align="right">
        <tr>
          <td colspan="2" align="left">Cianjur, <?php echo date('d F Y') ; ?></td>
          <!-- <td width="50%" ></td> -->
        </tr>
        <?php 
