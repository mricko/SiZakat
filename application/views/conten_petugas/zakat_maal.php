      ...
      <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  <div class="x_title pull-right">
                    <a href="<?php echo base_url('petugas/Dashboard') ?>"><i class="fa fa-home"></i>  Dashboard / </a><a href="#">Zakat Maal</a>
                  </div>
              ...
              <tbody>
                ...
                foreach ($maal->result() as $row) { ?>
                  <tr>
                    ...
                    <td  width="20%">
                      <center>
                      <a class="btn btn-primary" target="_blank" title="Print Kwitansi" href="<?php echo base_url('petugas/maal/print_kwitansi/' . $row->id_zakat_maal) ?>"><i class="fa fa-print"></i></button></a>
                      ...
                      <a class="btn btn-danger hapus-maal" title="Hapus Data " href="<?php echo base_url('petugas/Maal/hapus_data/' . $row->id_zakat_maal) ?>"><i class="fa fa-trash"></i></button></a>
                    </center>
                    </td>
                  </tr>
                <?php } ?>
